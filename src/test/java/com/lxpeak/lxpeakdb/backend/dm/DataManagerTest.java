...
public class DataManagerTest {
    ...
    public void testDMSingle() throws Exception {
        ...
        DataManager dm0 = DataManager.create("D://lxpeakdb/dbTest/TESTDMSingle", PageCache.PAGE_SIZE*10, tm0);
        ...
        new File("D://lxpeakdb/dbTest/TESTDMSingle.db").delete();
        new File("D://lxpeakdb/dbTest/TESTDMSingle.log").delete();
    }

    @Test
    public void testDMMulti() throws InterruptedException {
        TransactionManager tm0 = new MockTransactionManager();
        DataManager dm0 = DataManager.create("D://lxpeakdb/dbTest/TestDMMulti", PageCache.PAGE_SIZE*10, tm0);
        DataManager mdm = MockDataManager.newMockDataManager();
        ...
        new File("D://lxpeakdb/dbTest/TestDMMulti.db").delete();
        new File("D://lxpeakdb/dbTest/TestDMMulti.log").delete();
    }

    @Test
    public void testRecoverySimple() throws InterruptedException {
        TransactionManager tm0 = TransactionManager.create("D://lxpeakdb/dbTest/TestRecoverySimple");
        DataManager dm0 = DataManager.create("D://lxpeakdb/dbTest/TestRecoverySimple", PageCache.PAGE_SIZE*30, tm0);
        DataManager mdm = MockDataManager.newMockDataManager();
        dm0.close();
        ...
        int workerNums = 10;
        for(int i = 0; i < 8; i ++) {
            dm0 = DataManager.open("D://lxpeakdb/dbTest/TestRecoverySimple", PageCache.PAGE_SIZE*10, tm0);
        ...
        new File("D://lxpeakdb/dbTest/TestRecoverySimple.db").delete();
        new File("D://lxpeakdb/dbTest/TestRecoverySimple.log").delete();
        new File("D://lxpeakdb/dbTest/TestRecoverySimple.xid").delete();
