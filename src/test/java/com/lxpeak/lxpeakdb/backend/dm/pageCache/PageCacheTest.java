...
public class PageCacheTest {
    ...
    public void testPageCache() throws Exception {
        PageCache pc = PageCache.create("D://lxpeakdb/dbTest/pcacher_simple_test0", PageCache.PAGE_SIZE * 50);
        for(int i = 0 ; i < 100; i ++) {
        ...
        pc = PageCache.open("D://lxpeakdb/dbTest/pcacher_simple_test0", PageCache.PAGE_SIZE * 50);
        for(int i = 1; i <= 100; i ++) {
        ...
        assert new File("D://lxpeakdb/dbTest/pcacher_simple_test0.db").delete();
    }
    ...
    public void testPageCacheMultiSimple() throws Exception {
        pc1 = PageCache.create("D://lxpeakdb/dbTest/pcacher_simple_test1", PageCache.PAGE_SIZE * 50);
        ...
        cdl1.await();
        assert new File("D://lxpeakdb/dbTest/pcacher_simple_test1.db").delete();
    }
    ...
    public void testPageCacheMulti() throws InterruptedException {
        pc2 = PageCache.create("D://lxpeakdb/dbTest/pcacher_multi_test", PageCache.PAGE_SIZE * 10);
        ...
        assert new File("D://lxpeakdb/dbTest/pcacher_multi_test.db").delete();
    }
